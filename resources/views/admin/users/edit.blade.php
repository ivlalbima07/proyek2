        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="job">{{ __('Pekerjaan') }}</label>
                        {{-- <div class="col-sm-6"> --}}
                            <p><input id="job" type='radio' name='job' value='dosen' />Dosen</p>
                            <p><input id="job" type='radio' name='job' value='mahasiswa' />Mahasiswa</p>
                    </div>
                    <div class="form-group">
                        <label for="nim">{{ __('NIM/NPSN') }}</label>
                        <input type="nim" class="form-control" id="nim" placeholder="{{ __('NIM/NPSN') }}" name="nim" value="{{ old('nim') }}" />
                    </div>   
                    <div class="form-group">
